...
export default function InfoTooltip({ children, width = 'w-72' }) {
  return (
    <span className="relative inline-flex group align-middle ml-1">
      <span className="inline-flex items-center justify-center w-4 h-4 rounded-full border border-gray-300 text-gray-400 text-[10px] leading-none cursor-help select-none">
        ?
      </span>
      <span
