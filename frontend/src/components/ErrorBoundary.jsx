    ...
    if (this.state.error) {
      return (
        <div className="flex flex-col items-center justify-center py-24 text-center">
          ...
          <div className="text-lg font-semibold text-gray-800 mb-1">이 화면을 표시하는 중 문제가 발생했습니다</div>
          <div className="text-sm text-gray-400 mb-5">다른 메뉴는 정상 동작합니다. 아래 버튼으로 다시 시도하거나 새로고침하세요.</div>
          <div className="flex gap-2">
            ...
            <button
              ...
              className="px-4 py-2 rounded-md border border-gray-200 text-gray-600 text-sm font-medium cursor-pointer hover:bg-gray-50 transition-colors"
            >
              새로고침
            </button>
          </div>
