...
export default function StatCard({ label, value, sub = null, color = '', valueClass = 'text-2xl' }: { label?: ReactNode; value?: ReactNode; sub?: ReactNode; color?: string; valueClass?: string }) {
  return (
