...
function useKeyed(queryKey: any[], fetcher: () => Promise<any>, initial: any) {
...
const EMPTY_PORTFOLIO: any = { points: [], frontier: [], max_sharpe: { weights: [] }, min_vol: { weights: [] }, assets: [], n_obs: 0 }
const EMPTY_NETWORK: any = { nodes: [], edges: [], n_obs: 0 }
const EMPTY_PCA: any = { components: [], loadings: [], pc1_explained: 0, n_obs: 0 }
const EMPTY_CLUSTERS: any = { points: [], k: 0, n: 0 }
const EMPTY_DENDRO: any = { icoord: [], dcoord: [], labels: [], markets: [], categories: [], n_obs: 0 }
const EMPTY_GARCH: any = { cond_vol: [], forecast_vol: [], current_vol_annual: 0, var_95: 0, persistence: 0, n_obs: 0, korean_name: '' }
const EMPTY_MOM: any = { equity: [], total_return: 0, benchmark_return: 0, sharpe: 0, mdd: 0, long: [], short: [], n: 0, long_only: false }
const EMPTY_PAIRS: any = { pairs: [], tested: 0, found: 0, n_obs: 0, best: null }
const EMPTY_REGIME: any = { points: [], stats: [], current_regime: 0, current_label: '', n_states: 0, n_obs: 0 }

export const usePortfolio  = (markets: string[]) => useKeyed(['quant', 'portfolio', markets.join(',')], () => quant.getPortfolio(markets), EMPTY_PORTFOLIO)
...
export const useGarch      = (market: string) => useKeyed(['quant', 'garch', market], () => quant.getGarch(market), EMPTY_GARCH)
