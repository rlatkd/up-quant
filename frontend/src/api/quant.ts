...
export const getMomentum   = (top = 40, lookback = 20, holding = 5, longOnly = false) => api.get('/api/quant/momentum', { params: { top, lookback, holding, long_only: longOnly } }).then(r => r.data)
