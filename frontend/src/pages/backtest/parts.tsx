...
export function PngButton({ targetRef, name }: { targetRef: { current: any }; name: string }) {
  return (
...
export function MetricCard({ label, value, color = 'text-gray-800 dark:text-gray-100', sub = null }: { label?: ReactNode; value?: ReactNode; color?: string; sub?: ReactNode }) {
  return (
...
export function MarketSelect({ market, setMarket, tickers }: { market: string; setMarket: Dispatch<SetStateAction<string>>; tickers: Ticker[] }) {
  return (
