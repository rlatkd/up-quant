...
const GUIDE = [
  {
    route: '/',
    title: '대시보드',
    summary: '시장 전체를 한눈에 보는 요약 화면입니다.',
    features: [
      ...
      { tone: 'info',   name: '급등 · 급락 피드', desc: '등락률 상위 4종목(급등)과 하위 4종목(급락)을 나열합니다. 표시 전용입니다.' },
      { tone: 'action', name: '카테고리별 누적 수익률', desc: '우상단 [월 / 분기 / 년] 버튼을 누르면 기간 단위가 바뀝니다. 최근 5년간 5개 카테고리의 누적 등락률 라인차트입니다.' },
      { tone: 'info',   name: '카테고리 상관관계', desc: '5개 카테고리 간 월별 수익률의 피어슨 상관계수(-1~+1) 히트맵입니다. 빨강=양의 상관, 파랑=음의 상관.' },
      { tone: 'info',   name: '월별 카테고리 수익률 / 리스크-수익 분포', desc: '월별 등락률 히트맵과, X축 변동성·Y축 1개월 수익률의 산점도입니다. 점에 마우스를 올리면 상세 수치가 뜹니다.' },
    ],
  },
  {
    route: '/market',
