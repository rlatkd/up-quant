...
const GUIDE = [
  ...
  },
  {
    route: '/sectors',
    title: '섹터 분석',
    summary: '업비트 분류(섹터) 기준 수익률·상관관계와 종목 리스크-수익 분포를 봅니다.',
    features: [
      ...
      { tone: 'nav',    name: '리스크-수익 분포', desc: '거래대금 상위 30종의 X축 변동성·Y축 1개월 수익률 산점도입니다. 점에 마우스를 올리면 수치가 뜨고, 극단값 종목은 아래 표에서 클릭해 상세로 이동합니다.' },
    ],
  },
  {
    route: '/market',
