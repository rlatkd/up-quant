...
**다음 작업 (우선순위 순)**
1. [ ] **발표/영상 준비** — PPT 구성·대본·다른 LLM용 생성 프롬프트·스크린샷(`references/발표.md`), 5~7분 시연 영상
2. [ ] **포트폴리오 동선 통합** — 최적비중(★최대샤프/최소분산)을 백테스트·비교로 넘기는 동선("최적화→검증→비교"). 효율적 경계선 원 뭉침 시각 개선 포함
3. [ ] **에러 바운더리 추가** — Phase 23 흰 화면 크래시(작은 예외가 전 화면 언마운트) 계기
4. [ ] **실제 화면 검증** · **WebSocket 실시간 시세** · **분석 카트 필요성 재검토**
